...
ticket = yfinance.Ticker('TSLA')

tesla_data = ticket.history(period='max')
...
tesla_revenue_pd = pd.read_html(html_data)
tesla_revenue = tesla_revenue_pd[1]
...
tesla_revenue.to_excel('TESLA.xlsx')
